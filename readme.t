...
6] npm install @clerk/express
7] npm install prisma@6.17.1 --save-dev
8] npm install @prisma/client@6.17.1
9] npx prisma generate
10] npm install ws @prisma/adapter-neon @neondatabase/serverless
